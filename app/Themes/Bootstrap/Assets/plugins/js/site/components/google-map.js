...
jQuery(document).ready(function($){
  ...
  var latitude = 52.3073457,
      longitude = 6.4968468,
      map_zoom = 10;

  //google map custom marker icon - .png fallback for IE11
  var is_internetExplorer11= navigator.userAgent.toLowerCase().indexOf('trident') > -1;
  var marker_url = ( is_internetExplorer11 ) ? '/themes/admin/assets/images/widgets/gmap/cd-icon-location.png' : '/themes/admin/assets/images/widgets/gmap/cd-icon-location.svg';
